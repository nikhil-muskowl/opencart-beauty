...
class ControllerProductCategory extends Controller {
    ...
    public function index() {
        ...
        if ($category_info) {
            ...
            // http://googlewebmastercentral.blogspot.com/2011/09/pagination-with-relnext-and-relprev.html
            if ($page == 1) {
                $this->document->addLink($this->url->link('product/category', 'path=' . 'all'), 'canonical');
            } else {
                $this->document->addLink($this->url->link('product/category', 'path=' . 'all' . '&page=' . $page), 'canonical');
            }
            ...
            if ($limit && ceil($product_total / $limit) > $page) {
                $this->document->addLink($this->url->link('product/category', 'path=' . 'all' . '&page=' . ($page + 1)), 'next');
            }
